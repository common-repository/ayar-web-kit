...
Credits:TinyMCE, Ilya Lebedev, mk_is_here, Ko Soe Min, Saturngod, Ayar Myanmar Unicode Group.
Tested up to: 3.9.2
...
Features list:<ul>
<li>Unicode Encoding Converter</li>
<li>Burmese Luni Solar Calendar Widget</li>
<li>Ayar Toolbar (Dictionary, Online Converter, Zawgyi and Ayar Font Converter</li>
<li>Font Embedding Method</li>
<li>Calendar Header image icon</li>
<li>Encoding converter for RSS feed</li>
<li>Encoding converter and font embedding method for Mobile Device</li>
<li>For more information see change log</li>
</ul>
...
<li>1.0_beta_8 - bugs fixed and excluded fonts and css from plugin.
<ul>
...
<li>1.0_beta_9 - complete rewrite of plugin
<ul>
<li>Completely rewritten</li>
<li>excluded editor and virtual keyboard functions (Will be included in version 1.0 release).</li>
<li>include new calendar widget in luni-solar burmese system.</li>
<li>Font Embed Method for all encoding</li>
<li>Font Family Declaration with selected html tags</li>
<li>Server side encoding conversion system (Zawgyi to Unicode, Zawgyi to Ayar, Ayar to Zawgyi)</li>
<li>server side encoding converter for rss feed</li>
<li>server side encoding converter for mobile device</li>
</ul>
</li>
<li>1.0 fixed Bugs</li>
</ul>
== Others Notes ==
Road Maps
...
== Screenshots ==
1. Ayar Web Kit Options Page
2. Ayar Toolbar
3. English Calendar in burmese language.
4. Luni-solar Burmese Calendar Widgets.
5. Android Glaxy Tab
== Thanks ==
